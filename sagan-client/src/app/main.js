    ...
    switchButton.click(function() {
        if (body.hasClass(('dark'))) {
            ...
            body.addClass('light')
                .removeClass('dark');
            killInterval()
            consoleText(['Once You Learn To Read, You Will Be Forever Free.',
             'Reading Is To The Mind What Exercise Is To The Body.',
             'A Reader Lives A Thousand Lives Before He Dies...'], 'text',['black','black','black']);
        } else {
            set('theme', 'dark');
            ...
            consoleText(['Once You Learn To Read, You Will Be Forever Free.',
             'Reading Is To The Mind What Exercise Is To The Body.',
             'A Reader Lives A Thousand Lives Before He Dies...'], 'text',['white','white','white']);
        }
    });
...
$('#tutorial-hov span').focus(function () {
    removeNavClasses();
    $('#scope').addClass('tutorial-scope');
    $('#tutorial-items').addClass('active');
});
