ALTER TABLE project ADD raw_boot_config TEXT;
ALTER TABLE project ADD rendered_boot_config TEXT;

ALTER TABLE project ADD raw_overview TEXT;
ALTER TABLE project ADD rendered_overview TEXT;
